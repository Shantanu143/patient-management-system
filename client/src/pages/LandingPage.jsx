...
const LandingPage = () => {
  ...
  return (
    <div className="text-white md:px-20 px-10 mx-auto bg-custom-gradient min-h-screen flex flex-col ">
      ...
      <div id="continer" className="flex flex-col justify-center flex-grow">
        <div className="py-[1.5vw] relative z-10 ">
        ...
        <div className="flex flex-row flex-wrap justify-evenly">
          {[
            ...
            return (
              <div
                className="relative flex flex-col md:my-3 my-1 mx-1 bg-transparent shadow-sm shadow-blue-500 border border-blue-300 rounded-tl-lg rounded-br-lg rounded-bl-3xl rounded-tr-3xl max-w-60 p-2 text-start  ease-in transition-all duration-200 transform hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-700"
                key={index}
              >
                <div className="flex items-center flex-col ">
                  <div className="text-2xl p-2">{item.icon}</div>

                  <h5 className=" text-white font-semibold leading-tight p-2 sm:text-lg md:text-xl text-center">
                    {item.title}
                  </h5>
                </div>
                <p className="block text-slate-200 leading-normal font-light p-2 text-sm md:text-base text-center">
                  {item.desc}
                </p>
              </div>
            );
